...
namespace NEL.SimpleDB.API.SmartContract
{
    public class SimpleApplicationEngine : ExecutionEngine
    {
        #region Limits
        /// <summary>
        ...
        public SimpleApplicationEngine(Neo.SmartContract.TriggerType trigger, IScriptContainer container, Snapshot snapshot, Fixed8 gas, bool testMode = false)
            : base(container, Neo.Cryptography.Crypto.Default, snapshot, new NeoService(trigger, snapshot))
        {
        ...
        public long GetPrice(OpCode nextInstruction)
        {
